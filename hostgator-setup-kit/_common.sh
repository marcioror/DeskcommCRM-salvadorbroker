...
# que trocar junto — e, desde 18/09/2026, o CI do fork de origem não cobra este
# valor: a asserção só vale quando o dono do runner é o dono daquele repositório.

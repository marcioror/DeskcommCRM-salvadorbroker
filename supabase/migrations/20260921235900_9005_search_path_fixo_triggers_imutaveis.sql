-- ⚠️ RENUMERADA EM 21/09/2026, na reconstrução sobre a v1.41.0.
--
-- Nasceu como `20260907001000_0176_…` num fork cuja base era de 06/09. O upstream
-- já chegou a `0373` (`20260921040100`), então o carimbo antigo rodaria ANTES de
-- ~150 migrations dele, e o número colidiria com a numeração dele. Agora usa a
-- faixa `9xxx` desta casa, com carimbo posterior ao topo do upstream.
--
-- O conserto continua necessário: na v1.41.0, `fn_agent_versions_immutable` e
-- `fn_ai_agent_version_content_immutable` seguem sem `set search_path`.
